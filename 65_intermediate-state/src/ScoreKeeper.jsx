...
function ScoreKeeper() {
  ...
  setScores((oldScores) => ({ ...oldScores, p1Score: oldScores.p1Score + 1 }));
}

const increaseScore2 = () => {
  setScores((oldScores) => ({ ...oldScores, p2Score: oldScores.p2Score + 1 }));
}
  ...
  return (
    <div>
      ...
      <button onClick={increaseScore1}>+1 Player 1</button>
      <button onClick={increaseScore2}>+1 Player 2</button>
